select db_id,
       ...
       vg_dispQuarter "Qtr",
       vg_dispYear "Year",
       format(max(a.ms_maxvalue),2) "MBPS",
       format(max(b.ms_maxvalue),2) "CPU",
       format(max(c.ms_maxvalue),2) "DB Size"
