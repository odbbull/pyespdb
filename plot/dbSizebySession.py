...
fig = px.scatter(df, y="Sessions", x="storTotal", color="dbId", log_x=True, size="storTotal", 
                 size_max=60, hover_name="dbName", height=600, width=1000, template="simple_white", 
                 color_discrete_sequence=px.colors.qualitative.G10, title="Database Size by Sessions")
